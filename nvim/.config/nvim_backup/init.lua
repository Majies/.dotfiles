...
vim.keymap.set('n', ']<Space>', 'o<Esc>k', { desc = 'New line below' })
...
-- Center vertically on half page down and up
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gb', ':G branch<CR>', { desc = '[G]it [U]update [C]urrent (pull)' })
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>a', mark.add_file, { desc = '[A]dd file to harpoon buffer' })
      ...
      require('oil').setup {
        ...
        view_options = {
          ...
          is_always_hidden = function(name, _)
            for _, hidden_name in ipairs(hidden_names_list) do
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', builtin.git_files, { desc = '[S]search [G]it' })
      vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
      vim.keymap.set('n', '<leader>sw', builtin.grep_string, { desc = '[S]earch current [W]ord' })
      vim.keymap.set('n', '<leader>sa', builtin.live_grep, { desc = '[S]earch [A]ll strings' })
